...
def main():
    ...
    model_run_data['gt_latents'] = align_generation_run_data(model_run_data)
...
def align_generation_run_data(generation_run_data):
    """
    ...
    gt_latents[1.0] = generation_run_data['initial_noise']
